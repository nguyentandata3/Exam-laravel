...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-logout-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Aug 2022 21:28:17 GMT -->
<head>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Design & Developer by Tan Dat</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> <a href="#">TanDat.com</a> Crafted with <i class="mdi mdi-heart text-danger"></i> by Tan Dat
                            </p>
                        </div>
                    </div>
                </div>
