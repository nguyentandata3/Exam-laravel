        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5><p class="text-muted">Sign in to continue to Exam Online.</p></h5>
                            </div>
                            <div class="p-2 mt-4">
                                <form action="{{ route('postLogin') }}" method="post">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ url('/auth/redirect/facebook') }}"><button type="button" class="btn btn-primary btn-icon waves-effect waves-light"><i class="ri-facebook-fill fs-16"></i></button></a>                                 
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">Don't have an account ? <a href="{{ route('getRegister')}}" class="fw-semibold text-primary text-decoration-underline"> Signup </a> </p>
                    </div>
